  ...
  freyja: {
    overview: {
      ...
      blocks: [
        {
          type: "text",
          content: `Freyja är inte en fiktiv värld.

Detta står i vår egen.

I skogsbryn, i trädgårdsjord, i rök, i årstidernas skiften och i de äldre namn som fortfarande ligger kvar under det moderna språkets yta.

Musiken rör sig nära ritual, natur, kropp, minne och det som ännu känns heligt utan att be om tillstånd.`
        },
        {
          type: "text",
          content: `Här är det inte berättelsen som bär allt.
...
att samla örter, att tända eld, att ställa ut vatten, att märka hur mörkret förändras mellan oktober och februari.

Det är ingen flykt från världen.

Det är ett sätt att stå i den med större skärpa.`,
      showPlaceholder: false
    },
    threshold: {
      menuTitle: "Tröskeln",
      title: "Tröskeln",
      text: `Det finns platser som inte ser ut som mycket alls förrän man återvänder till dem tillräckligt många gånger.

En grind.
Ett träd.
En sten.
En stigkant där något alltid blir stilla.

Tröskeln är inte alltid dramatisk.
Ofta är den bara igenkänd.`,
      showPlaceholder: false
    },
    mailysa: {
  ...
  blocks: [
    {
      ...
      size: "medium",
      alt: "Mailýsa Freyja",
      caption: "Kvinna. Moder. Häxa. Avbild och bärare."
    },
    {
      type: "text",
...
Inte en flykt från det egna jaget, utan ett annat sätt att låta vissa sanningar träda fram tydligare.`
    },
    {
      type: "text",
      content: `I henne möts det vårdande och det farliga, det jordbundna och det heliga, det mjuka och det obevekliga.

Hon bär sådant som inte alltid får plats i vardagens språk:
den som minns,
den som bär,
den som vårdar,
den som kallar,
den som vägrar böja sig,
den som vet när något måste skäras bort.`
    },
    {
      type: "text",
...
I tända ljus.
I kök, trädgårdar, skogsbryn och nattluft.
I sorg som blivit styrka.
I skönhet som inte ber om ursäkt.
I häxkonst som inte leker symbol, utan söker närvaro, handling och relation.`
    }
  ],
  showPlaceholder: false
}
...
De blir bara svårare att ignorera.`
  ...
  music: {
    overview: {
      menuTitle: "Översikt",
      title: "Musiken",
      text: `Musiken i Freyja hör hemma i vår värld, men rör sig i dess äldre skikt.

Den dras mot ritual, naturmystik, gudinnor, häxkonst, begär, sorg, återkomst och kraft utan prydlighet.

Här finns ingen fiktiv kontinent att förklara.
Bara våra egna landskap — sedda med andra ögon.`,
      showPlaceholder: false
    },
    
    songsNature: {
      menuTitle: "Natur och längtan",
      title: "Natur och längtan",
      intro: `Dessa sånger är om naturen, dess under och skönhet och längtan efter något äldre, något naturligare.`,
      layout: "cards",
      columns: 4,
      cards: [
    {
  ...
  showPlaceholder: false
    ...
    songsDivine: {
      menuTitle: "Det Gudomliga",
      title: "Det Gudomliga",
      intro: `Dessa sånger är om Gudinnan Freyja själv - och övriga av de Gudomliga.`,
      layout: "cards",
      columns: 4,
      cards: [
    {
  ...
  showPlaceholder: false
    ...
    songsCreatures: {
      menuTitle: "Varelser",
      title: "Varelser",
      intro: `Dessa sånger är om varelser så ovanliga att träffa på att de ofta kallas mytiska.`,
      layout: "cards",
      columns: 4,
      cards: [
    {
  ...
  showPlaceholder: false
   ...
   songsSpirits: {
      menuTitle: "Spöken och andar",
      title: "Spöken och andar",
      layout: "cards",
      intro: `Dessa sånger är om glömda, förlorade, plågade själar som tvingats - eller valt - att stanna kvar.`,
      columns: 4,
  cards: [
    {
  ...
  showPlaceholder: false
    ...
    songsWitchcraft: {
      menuTitle: "Häxerier och trolldom",
      title: "Häxerier och trolldom",
      intro: `Dessa sånger är inte för alla. Området beträdes på egen risk - eller vinst.`,
      layout: "cards",
      columns: 4,
  cards: [
    {
  ...
  showPlaceholder: false
    ...
    fragments: {
      menuTitle: "Fragment",
      title: "Fragment",
      text: `Allt behöver inte vara färdigt för att vara sant.
  ...
  showPlaceholder: false
   ...
   hauntedPlace: {
    ...
    blocks: [
      ...
      {
        type: "text",
        content: `<i>Baserad på dikten av <b>Edgar Allan Poe</b></i><br>
...
`
   ...
   mostCurious: {
    ...
    blocks: [
      ...
      {
        type: "text",
        content: `<i>Översättning av <b>Den märkvärdiga mannen</b> av Wilhelm von Braun</i><br>
  ...
  showPlaceholder: false
   ...
   laughingFace: {
    ...
    blocks: [
      ...
      {
        type: "text",
        content: `<i>Baserad på <b>Mitt konterfej</b> av Wilhelm von Braun</i><br>
...
love carries on`
   ...
   deathIsNothingAtAll: {
    ...
    blocks: [
      ...
      {
        type: "text",
        content: `<i>Text av <b>Henry Scott Holland</b> från en predikan 1910.</i>
...
Den sörjande.
Den som vägrar böja sig.
Den som vet vad skogen kostar.

Inte som rollfigurer, utan som återkommande former i mänskligt liv och religiös erfarenhet.`
    },
    symbols: {
      menuTitle: "Symboler",
      title: "Symboler",
      text: `Runor, bin, katter, falkar, eld, nycklar, blod, frön, koppar, slöjor, horn, äpplen, lin, guld, rök.

Vissa symboler väljer man.
Andra verkar välja tillbaka.`
    },
    fragments: {
      menuTitle: "Textfragment",
      title: "Textfragment",
      text: `Här kan kortare stycken få finnas utan att pressas in i längre förklaringar.

Det som bär sin mening bäst i liten skala skall inte dras ut bara för att fylla plats.`
    }
  },
  ...
  about: {
    concept: {
      menuTitle: "Koncept",
      title: "Koncept",
      text: `Freyja är ett fristående musikaliskt och estetiskt projekt.

Det rör sig i vår värld, inte i en uppfunnen.
Det hämtar kraft ur natur, ritual, nordiska och bredare förkristna resonanser, häxkonst, kroppslighet och andlig tyngd utan att bli museum eller pastisch.

Målet är inte att efterlikna det förflutna, utan att låta något äldre fortsätta tala i nuet.`,
      showPlaceholder: false
    },
    process: {
      menuTitle: "Process",
      title: "Process",
      text: `Projektet växer fram genom växelverkan mellan musik, bild, symbolik och kortare textfragment.

Ibland börjar något i en stämning.
Ibland i en gudomlig association.
Ibland i en årstid, en doft, ett stycke jord, eller ett ord som vägrar släppa taget.

Det viktiga är inte att allt förklaras.

Det viktiga är att det känns sant.`
    },
    log: {
      menuTitle: "Arbetslogg",
      title: "Arbetslogg",
      text: `2026-03-28 - Första generationen websida för Freyja påbörjad.

Här kan utvecklingsnoteringar, visuella beslut och innehållsmässiga milstolpar samlas över tid.`
    }
  }
};