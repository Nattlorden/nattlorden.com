const chaptersSV_01_05 = {
  chapter01: {
  menuTitle: "Kapitel 1",
  title: "Kapitel 1 – Keri McCree",
  pageType: "chapter",
  hidden: true,
    ...
    sections: [
      {
        type: "text",
        content: `
<p>En hand på axeln fick henne att rycka till. Herr Giorgi, gillesmästare, betraktade henne med rynkad panna.
”Hur är det fatt, Keri? Mår du inte bra?”
Hon drog ett djupt andetag, släppte taget om minnet och fann rösten.
”Bara bra. Jag funderade på hur jag skulle se ut i det här tyget.”
Giorgi följde hennes blick, men hade redan öppnat gillets liggare.
”Ingen har bjudit än,” sade han och pekade på balen. ”Utropet är tjugofem silver för hela partiet. Rimligt, med tanke på resan hit.”
Hon log åt hans sedvanliga tonfall. ”Du förnekar dig aldrig. Finns det fler intresserade?”
”Bara Silvio – han köper vardagstyger. Säljaren kommer själv nu. Tala med honom direkt. Och glöm inte kammarens provision.”</p>

<p>En svartmuskig man närmade sig, klädseln mer sjömans än handelsmans. Keri gick honom till mötes och sträckte fram handen.
”Keri McCree, damskräddare. Jag är intresserad av ert satängtyg.”
”Dramond Hezhen, till er tjänst…” Han tog hennes hand och kysste den i en galant gest som fick hennes mun att dra sig till ett spelat leende.</p>

<p>Förhandlingen blev kort men skarp. Trettiotvå silverdaler med matchande tråd, och en tydlig markering att hon inte blandade privatliv och affärer senare var köpet hennes.</p>

<p>Giorgi böjde sig över gillets liggare, pennan rispade mot pergamentet när han förde in orden:
<i>”30:e Savor, år 720. Två balar satäng från Dramond Hezhen till Keri McCree. Köpet fullgjort utan auktion.”</i>
Han blåste lätt på bläcket, slöt boken med en smäll och log snett.
”Sista dagen på hösten… njut av den. Nu kommer vintern.”
Keri mötte hans blick, och i rummet låg ett ögonblick av stillhet. Golothas vinter var inget att ta lätt på – fukt och kyla som smög in i varje spricka, stormar från havet, och snart snö och is som band staden i järn.</p>
...
Leendet han lämnade henne med var både löfte och utmaning, och när han försvann mellan bodarna låg ekot av stegen kvar i golvet.</p>`
      ...
      {
        type: "text",
        content: `<p>Butiken låg stilla när skymningen föll. Ljuset från oljelampan kastade mjuka skuggor över hyllorna, och doften av lin, ull och vax låg kvar i rummet.
Keri hade tagit fram en klänning hon sytt för länge sedan, ett övningsstycke i sömnadens finare konst. Den var mörkblå, snittad för att framhäva hållning snarare än prakt, med sömmar som bar spår av både envishet och skicklighet. Hon hade aldrig haft tillfälle att bära den – hennes umgänge krävde inget sådant – men nu, i skenet från lampan, slöt hon plagget om sig och kände hur det förändrade henne.
I spegelglaset såg hon sitt eget ansikte. Håret var djupt kastanjebrunt, med röda stråk som glimmade i ljuset. Huden bar blekhet efter dagarna i verkstaden, men ögonen var klara, vaksamma. Klänningen gav henne en annan tyngd, förvandlade henne från hantverkare till kvinna som kunde mäta sig med köpmännen vid kajen.
Från trappan hördes steg. Kelly klev upp med bestämda rörelser, bredaxlad under den enkla blusen, och i handen bar hon en kort dolk. Greppet var inlindat i nött läder, ett bruksting snarare än prydnad. Hennes hår var rödblont, ljust men med en ton av flamma i lyktans sken.
”Ta den här,” sade hon kort.
Keri vände sig om, höjde ögonbrynet. ”En dolk? Till en middag?”
”Till en båt,” svarade systern torrt. ”Man vet aldrig.”
Keri tog emot den utan protest. Hon fäste den vid låret under kjolfållen, och stålet blev en del av hennes närvaro lika naturligt som klänningen hon nyss dragit på sig.
I dörröppningen stod Athina, stilla som en skugga, sjalen hårt virad kring axlarna. Hennes hår föll askblont och spikrakt till midjan. Hon sade inget, men hennes ögon, stålblå i lampans ljus, vilade på Keri med en tyngd som inte behövde ord. En kort nick, ett avsked, och mer än så.
Keri drog kappan tätare, släckte lampan och stängde dörren. Kvällsluften slog emot henne: en blandning av flodens salta drag och rök från husens eldar. Längre bort hördes sjömännens rop, grova stämmor i takt med rep och last. Hon gick mot kajen, med klänningens tyg mot huden och dolkens tyngd vid låret.</p>

<p class="medium-break">Kajen låg mörk i kvällningen, upplyst bara av några spridda lyktor som kastade guldfläckar över våta plankor. Här och var brann en fackla i ett järnstag, och längre bort glödde ett fyrfat där några sjömän värmde händerna. Längs raden av skepp steg ropen, grova stämmor som blandades med gnisslet av rep och dunket av tunnor. Tjära och salt slog emot henne när hon närmade sig västra kajen. Kappan var sluten tätt om kroppen.
Hon stannade till när hon fick syn på <i>Sjöugglan</i>. En slank brigg med vitmålad reling och ett akterskepp vars fönster lyste varmt i lyktornas sken – men det som verkligen fick henne att höja på ögonbrynen var var hon låg. <span class="place-name">Kalphor</span>. På södra flodsidan.
Det var en kajplats som knappast tilldelades fartyg av den här storleken. För att komma hit måste de rörliga broarna ha svängts undan – hennes master skulle aldrig gå under stenbron. Normalt låg här bara de skepp som hörde Thard-floden till för gott. Att <i>Sjöugglan</i> förtöjts här sa mer än något av Dramonds leenden: han hade inflytande.
På däck rörde sig ett par män tysta mellan lastluckorna, men vid landgången stod Dramond själv. Han bar en mörk jacka med silkesfodrad väst som blänkte svagt i ljuset från lyktorna. Ringen på hans finger fångade skenet när han höjde handen i hälsning.
”Mäster McCree. Jag tvivlade nästan på att ni skulle komma.”
Keri lät blicken svepa över fartyget innan hon svarade. ”När man blir inbjuden till en middag på ett skepp man aldrig satt sin fot på, är tvekan naturlig.”
Han log, visade den glimmande guldtanden. ”Och ändå är ni här.” Han erbjöd armen med en artighet som kändes inövad.
Keri tog steget ombord. Brädorna gungade lätt under klackarna, och kontrasten mellan hennes mörkblå klänning och skeppets saltstänkta däck fick flera av männen att kasta en nyfiken blick. Hon höll ryggen rak, svarade inte på deras viskningar. Dramond ledde henne mot aktern där lyktorna brann starkare.</p>

<p>Akterskeppet tog emot dem med doften av kryddor och vin, en skarp kontrast mot kajens saltstänk och tjära. Dramond öppnade dörren till kajutan och lät henne stiga in först, som en värd som visste sitt värde.
Rummet var lågt, men klätt med omsorg. Väggarna bar paneler av mörkt trä, putsade till glans. I taket hängde två lyktor i svängande krokar, och deras flämtande lågor kastade varmt sken över bordet som redan var dukat. Där stod fat med bröd, ost och frukt, en gryta som fortfarande ångade, och en karaff vin vars röda sken spelade i glaset.
Keri tvekade en sekund på tröskeln. Den mörkblå klänningen kändes främmande bland skeppets slitna timmer, men hon höll ryggen rak, tog steget in och lät kappan glida av axlarna. Hon mötte Dramonds blick som om hon gjort detta hundra gånger förr.
Han log och drog ut en stol åt henne. 
”Jag hoppas enkelheten ursäktas. Man får ta vad skeppet kan ge – men det finns en charm i det också, tycker ni inte?”
Keri lät blicken svepa över bordet innan hon satte sig. 
”Charm kan vara lika mycket en fråga om vad man ser som vad som finns. Men det ser inbjudande ut.”
Han skrattade lågt, nöjd över svaret, och slog sig ned mitt emot.</p>

<p>De första skivorna bröd och ost plockades mer för artighet än hunger. Det var när Dramond lyfte på locket till grytan som doften vällde upp, skarp och frisk, syra från lime blandad med köttets tyngd.
”Fasan,” sade han med ett leende, ”stekt långsamt och sedan sjuden i lime och örter. En vän från Azadmere lärde mig att uppskatta den här smaken.” Han skar upp köttet med van hand och lät bitarna falla över fat med rostad rova och morot. ”I Melderyn fann jag något liknande, fast med saffran och kanel. Men deras hov köper upp allt, så man får smaka genom omvägar.”
Keris ögon smalnade en aning. <i>Melderyn? Få når dit, och färre talar öppet om det. Skrävleri… eller sanning?</i>
Den friska syran från limen blandades med doften av rosmarin och vitlök, och i bakgrunden låg en sötma från honungen som glaserat fågeln. Det var en måltid som var lika mycket ett utspel som en bjudning.
”Ni vet att göra intryck,” sade hon, röstlagd mellan artighet och prövning.
Han log, höjde sin bägare. ”Och ni vet att inte låta er förtrollas för lätt. Det uppskattar jag. Många hade redan sjungit min sång.”
De åt en stund i tystnad, bara ljudet av bestick mot fat och lyktans knäppande låga. Dramond lät henne smaka först, som om det var en prövning, och när hon nickade sakta åt smaken drog han efter andan som en man som fått sitt omdöme bekräftat.
”Ni driver en tyghandel, sägs det? Ett skrädderi?” Hans blick var vaksam, prövande. ”Ett gott hantverk, men ni är fortfarande ung. Ung för att stå ensam i Golotha.”
Keri lade ifrån sig besticken och mötte hans blick. ”Jag har aldrig gillat det ordet… det låter så banalt. Men i grunden, ja.” Hon drog efter andan, höll blicken stadig. ”Ung, ja. Ensam, nej. Jag har min familj, och jag har mina egna händer. Andra har byggt stort från mindre.”
Ett lågmält skratt, varmt men med en egg. ”Så det är. Men ibland krävs vänner utanför familjen. Ni borde överväga det.”
”Vänner,” upprepade hon lågt, ”eller bundsförvanter?”
Han höjde bägaren igen, som för att inte behöva svara.</p>

<p>Dramond fyllde på hennes bägare, och samtalet gled bort från affärer. Hans blick vilade mer på henne än på orden, och till slut reste han sig, gick bort till chiffonjén och lyfte fram en liten ask.
”En gåva,” sade han, och höll upp ett halsband av fint silver med ett litet infattat glas som glimrade i lyktans sken. ”Ert arbete är vackert, men er hals… den förtjänar att inte stå bar.”
Han stod bakom henne, och för en sekund var luften mellan dem för tät. Keri förde handen närmare kjolfållen där dolken vilade, men gjorde som han bad. Smycket föll svalt mot huden, spännet klickade fast.
”Så,” sade han mjukt, ”nu ser ni ut som den dam ni är.”
Keri lät fingrarna snudda vid halsbandet, men hennes blick när hon vände sig mot honom var kyligt behärskad. ”Jag tackar för er artighet, men låt inte smycket lura er. Jag definieras inte av vad någon hänger runt min hals.”
Dramond lutade sig mot bordet, höjde bägaren långsamt och sade lågt, nästan som till sig själv: ”Då är vi förstådda.”
Ett ögonblicks tystnad följde, innan han log igen, nästan uppskattande, men med en ton av något ofullbordat.
Då öppnades dörren tvärt. Kelly klev in utan att knacka, rörelsen snabb och målmedveten. Hennes blick svepte över rummet, fastnade på halsbandet, och sedan på Dramond.
”Det räcker,” sade hon lågt men med klang som skar genom kajutan, lika skarp som klingan i hennes hand. ”Min syster går nu. Håll fingrarna i styr om ni vill behålla dem.”
Dramond öppnade munnen för att svara men mötte hennes blick och slöt den igen. Keri hade redan rest sig med ett roat litet skratt. Hon drog kappan över axlarna, mötte hans blick en sista gång och log – kort, men med en underton som sade att han inte fått mer än hon velat ge.
Hon lät fingertopparna snudda vid halsbandet, en gest som kunde vara både prövande och ett tyst tack.
”Tack för middagen,” sade hon. ”Det var… lärorikt.”
Sedan gick hon ut bredvid Kelly, och kvar i kajutan stod Dramond, ensam med vinets doft och halsbandets tomma ask.</p>

<p>Nattluften slog emot dem när de lämnade skeppet. Floden låg mörk och tung under stjärnljuset, med stråk av dimma som redan kröp in från vattnet. Ljudet från kajen – rop, rep, last – dog snabbt bort bakom dem, och kvar fanns bara vindens vissel mellan husgavlarna.
Keri drog kappan tätare och lät fingrarna en gång till röra vid halsbandet, som för att känna dess kyla mot huden. Kelly gick bredvid, stegen korta och hårda mot gatstenen.
”Du hade stannat längre än klokt,” sade hon, blicken framåt, rösten låg men vass. ”Det såg jag redan när jag öppnade dörren.”
Keri svarade inte genast. Hennes andedräkt blev till små moln i mörkret innan hon sade: ”Ibland är det klokt att stanna. Och att gå i tid.”
Kelly snörpte på munnen men höll tyst efter det. Gatorna var smala, husen mörka, och skenet från en ensam lykta kastade skarpa skuggor över murarna. En hund skällde någonstans längre bort.
Sida vid sida genom Golothas natt, tysta nog för att höra sina egna hjärtslag, tills de svängde in mot kvarteren där deras eget hus låg.</p>
`
      },
      {
        type: "image",
