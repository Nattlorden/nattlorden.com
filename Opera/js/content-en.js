...
Come from Away`
    ...
    {
      type: "image",
      src: "http://www.nattlorden.com/images/hifi/stubbe.jpg",
      alt: "?",
      caption: "??"
    }
...
/*
    software: {
      menuTitle: "Mjukvara",
      title: "Mjukvara",
      text: `Mjukvaran är den osynliga halvan av systemet, och ofta den som avgör om tekniken känns smidig eller bara irriterande.
...
`,
  showPlaceholder: false
    ...
    act1: {
      ...
      Up to and including Guinevere's trembling hand.
      `,
      showPlaceholder: false
    },
...
<br>Ends quietly: distant female voices, cold wind over dark water disappearing into silence.`
  ...
  blocks: [
    {
      type: "scene",
      title: "Act I, Scene II — The bells beyond the water",
...
Chi risponde dal convento?`,
      translation: `The bells... the bells...
beyond the water, beyond the wind,
who calls them in the night?
Who answers from the convent?`
    },
    {
      type: "line",
      voice: "Choir",
      note: "varying lead singer",
      original: `Cade il velo sopra il lago,
tace l’isola nel blu.
Dove andavano le barche,
non si vede Avalon più.`,
      translation: `The veil falls over the lake,
the island is silent in the blue.
Where the boats once sailed,
Avalon is no longer visible.`
    },
    {
      type: "line",
      voice: "",
...
re senza pace, popoli e greggi.`,
      translation: `Crosses arise on the hills,
new altars, new laws.
Sword and fire along the borders,
peaceless kings, peoples and flocks.`
    },
    {
      type: "line",
      voice: "",
...
ogni strada chiama strada.`,
      translation: `A time of crowns comes,
a time of swords comes.
Every house listens and trembles,
every street calls out.`
    },
    {
      type: "line",
      voice: "",
...
solo il mare resta amico.`,
      translation: `Who has seen the white deer?
Who has heard the ancient horn?
Only the wind bears the name,
only the sea remains a friend.
`
    },
    {
      type: "line",
...
chi ricorda il primo nome?`,
      translation: `Mothers, sisters, daughters of the river,
guard the little light.
If the fog closes the heart,
who remembers the first name?
`
    },
    {
      type: "line",
...
Britannia vivrà.`,
      translation: `A promised king is coming.
Order will be born.
Heaven has chosen it's iron.
Britain will live.`
    },
    {
      type: "line",
...
è l’antico sangue della terra.`,
      translation: `But beneath the bronze of the bells,
beneath the voice of the new gods,
something cries in the fountains,
something dies within us.

It is not a storm,
it is not a battle,
it is not just death or war.
It is the memory that grows thin,
it is the ancient blood of the earth.`
    },
    {
      type: "line",
      voice: "",
...
non tornare solo in canto.`,
      translation: `Avalon…
Avalon…
do not leave us without dreams,
do not return alone in song.`
    },
    {
      type: "line",
      voice: "",
...
Pane, ferro, legge e fame.`,
      translation: `If the fog blocks the path,
if the shore loses its name,
what remains for the lonely man?
Bread, iron, law, and hunger.`
    },
    {
      type: "line",
      voice: "",
...
Chi saprà ancora ricordare?`,
      translation: `The bells beyond the water
bring no peace.
They bring the dawning day
and the silent night.

O Britain, divided land,
between the cross and the ancient altar,
who will save your wound?
...
May heaven guard his path.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Hanno lasciato la corona sul tavolo
come si lascia una spada dopo la guerra.
E tutti guardavano me
come se il cielo avesse già parlato.

Io conosco il rumore delle stalle,
la pioggia sopra il ferro delle porte,
le mani sporche di terra e inverno.
Non conosco il peso delle leggende.

Eppure ogni strada porta il mio nome.
Ogni volto cerca nei miei occhi
qualcosa che non so dare,
qualcosa più grande di un uomo.

Forse un regno nasce così:
dal bisogno,
non dalla gloria.

Forse la speranza degli uomini
sceglie da sola il proprio volto.

Ma questa corona pesa più del ferro,
più della notte sopra le colline.
Non è oro:
è voce,
attesa,
paura.

E se davvero devo guidarli,
fa’ che io resti uomo
sotto il canto del popolo,
sotto il peso del destino.

Li ho sentiti cantare nelle piazze.
Arthur…
Arthur…

Come se il nome bastasse
a fermare il sangue nei campi.
Come se bastasse un re
a guarire la memoria della terra.

Merlin dice:
“Un uomo non sceglie sempre il tempo in cui nasce.”
Forse è vero.

Ma certe notti
vorrei ancora camminare senza simboli,
senza occhi rivolti verso di me.

Che cosa vede il popolo
quando guarda una corona?
Un uomo?
Un sogno?
O soltanto una paura vestita di luce?

Questa corona pesa più del ferro,
più delle pietre, più del mare.
E ogni speranza che sale verso di me
diventa silenzio nelle mani.

Se davvero il cielo mi ha chiamato,
che mi conceda almeno questo:
...
a silent reminder that the old world is still watching from beyond the mists.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Questa mattina le porte sono aperte.
Nessuno corre.
Nessuno grida nel mercato.

Perfino il vento sembra più leggero
quando attraversa le torri di Camelot.

Ho visto bambini rincorrere il sole
dove prima cresceva soltanto paura.
Ho visto mani posarsi senza tremare
sulle tavole semplici della sera.

E per un momento
questa terra ferita
ha respirato piano
come dopo una lunga febbre.

Forse la pace non nasce dai re.
Forse nasce così:
da fuochi accesi nelle case,
dal pane diviso senza timore.

Se questo sogno deve vivere,
che viva nei volti della gente.
Non nelle corone,
non nelle leggende,
ma nella fragile bontà degli uomini.

Che Camelot sia luce nelle finestre,
...
Let those who have known war
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Arthur ascolta troppo il silenzio.
Porta già ombre dietro gli occhi.
Eppure quando guarda il popolo
qualcosa dentro lui si addolcisce.

Come se anche lui desiderasse
non gloria…
ma soltanto una casa
che il tempo non distrugga.

Io non chiedo eternità.
Nulla umano vive senza inverno.
Ma lascia che questa stagione duri abbastanza
da insegnare ai cuori la speranza.

Se questo sogno deve vivere,
che viva nel canto delle sale,
nel suono lieve delle campane,
nelle mani che costruiscono insieme.

Che Camelot sia memoria gentile
in un mondo nato dalla cenere.
E se la notte tornerà ancora,
che trovi almeno una luce accesa.
...
Camelot…`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Una volta il bosco parlava piano.
Non con voce d’uomo…
con ali,
con acqua,
con luce tra le foglie.
...
Avalon…`
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Vicino alle vecchie pietre
...
what has stopped breathing.`
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Anche il bosco cambia odore.
Meno pioggia.
Più fumo.

I bambini imparano nuove preghiere
...
remain alone in the evening.`
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Forse questo è il destino.
Forse ogni regno
...
makes room for the cold.`
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Ogni canto dimenticato
rende il mondo più pesante.

Merlin ascolta ancora le pietre.
Io ascolto ancora l’acqua.
Ma le rive si allontanano.

Camelot splende sulle colline.
Le sue finestre brillano come stelle.
E il popolo finalmente ride.
...
where once the world knew how to dream.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Ho camminato dopo che le voci
si sono spente nelle sale.
La pioggia cadeva lenta sulle mura
come se il cielo ascoltasse ancora.

Morgaine vede morire il mistero.
— E forse…
forse non ha torto.
Anch’io ricordo boschi più profondi,
strade perdute dentro la nebbia,
acque che sembravano custodire
nomi più antichi degli uomini.

Ma cosa resta a chi vive nel freddo?
Cosa resta ai bambini senza pane?
Un regno non nasce soltanto dai sogni.
Nasce dal fuoco acceso contro l’inverno.

Se il mondo cambia fra le nostre mani,
non sempre cambia per superbia.
A volte gli uomini costruiscono mura
soltanto per dormire senza paura.
E se nel fare questo
...
until the end of my days.`
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Non desideravo diventare simbolo.
Le leggende divorano il volto degli uomini.
Eppure ogni strada conduce a me
come acqua che cerca il mare.

Merlin tace sempre più spesso.
E nei suoi occhi vedo stanchezza
più antica delle pietre.

Forse ogni tempo
perde qualcosa di sacro
per salvare ciò che può ancora vivere.

Se il mondo cambia fra le nostre mani,
che almeno impari la misericordia.
Che Camelot non diventi soltanto ferro,
ma memoria viva della compassione.

E se Avalon si allontana nella nebbia,
io non riderò della sua assenza.
Perché anche ciò che svanisce
...
Le ho viste nascere nei racconti dei viandanti,
nelle sale illuminate dal vino,
nelle canzoni dei soldati lungo la strada.

Ma nessuna voce
era abbastanza grande per questa luce.

Le porte restano aperte al tramonto.
I bambini corrono senza paura.
Persino il ferro delle guardie
sembra più lieve sotto queste mura.

Ho attraversato regni consumati dalla guerra.
Ho visto uomini inginocchiarsi davanti alla fame.
Qui…
perfino il vento parla più piano.

“Benvenuto a Camelot!”
“Un altro cavaliere per la Tavola Rotonda!”
...
non è stato creato invano.

Camelot…
tu splendi come fuoco nella pioggia.
Non per oro,
non per gloria,
ma per la speranza negli occhi della gente.

E Arthur porta la corona
...
God…`
    },
    {
      type: "line",
      voice: "Lancelot",
      original: `Cammina fra il popolo
...
Lasciate che io serva questa terra.
Lasciate che il mio nome
diventi pietra nelle sue mura,
ferro nelle sue porte,
luce nelle sue sale.

Camelot…
se davvero il cielo guarda gli uomini,
forse guarda qui questa sera.
...
Where even strangers`
    },
    {
      type: "line",
      voice: "Lancelot",
      original: `sentono meno freddo nel cuore.

E se un giorno tutto questo dovrà cadere,
lasciate che io cada
...
At last…`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Le sale finalmente dormono.
Anche le ultime torce
si consumano piano nella notte.

Camelot tace…
eppure il mio cuore
non trova silenzio.

Ho ascoltato cento voci questa sera,
risate, vino, promesse di pace.
Ma fra tutte
una sola presenza
resta ancora accesa dentro di me.
...
e l’aria cambia profumo.

Sir Lancelot sorride
come chi non ha ancora imparato
a dubitare della luce.

E guardandolo
perfino le vecchie pietre di Camelot
sembrano meno stanche.

Come ritorna la primavera
in un giardino creduto perduto,
così qualcosa dentro il mio cuore
si è mosso senza chiedere permesso.
...
like gentle rain upon the evening.`
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Arthur porta il peso del regno
anche quando nessuno lo vede.
E io conosco la bontà delle sue mani,
...
Eppure…
quando Lancelot parla,
il mondo sembra più giovane.

Forse non amo lui.
Forse amo
la parte di me
che credeva ancora nei miracoli.

Come ritorna la primavera
anche ai rami più segnati dal gelo,
così una luce inattesa
ha sfiorato la mia anima stanca.

Ma ogni fiore troppo fragile
teme il ritorno dell’inverno.
E il mio cuore già conosce
quanto costa la bellezza agli uomini.

Camelot dorme sotto le stelle…
...
afraid of her own dream.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Lancelot",
      original: `Le ultime voci si spengono piano.
Resta soltanto il vento
fra le torri illuminate.

E io…
non riesco ancora a dormire.

Ho conosciuto guerre,
strade consumate dalla pioggia,
uomini pronti a vendere il proprio nome
per un giorno senza fame.

Poi Camelot ha aperto le sue porte…
e per la prima volta
forse il mondo può essere salvato.
...
Ma c’è troppa luce in queste sale,
troppa bellezza nelle cose semplici.
Il cuore dimentica di difendersi
quando il mondo diventa gentile.

E forse è questo il vero pericolo:
non l’odio,
non la guerra,
...
Io non desidero tradire nulla.
Non Arthur.
Non Camelot.
Non il sogno che ci tiene uniti.

Eppure qualcosa cresce nel silenzio
come radice sotto la neve.

C’è troppa luce in queste sale,
troppa speranza nelle mani della gente.
E il mio cuore,
stanco di battaglie,
comincia a credere
...
the sweetness of this night.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Le torce splendono come stelle
lungo le sale di Camelot.
I cavalieri abbassano il capo.
Le campane chiamano la gloria.

E questa notte
un nuovo nome
siederà alla Tavola Rotonda.

Sir Lancelot avanza piano
fra luce, ferro e preghiere.
Così giovane…
e già amato
come un canto imparato da sempre.

Il popolo trattiene il respiro.
Perfino le vecchie pietre
sembrano ascoltare.

Io devo soltanto
sollevare la spada,
pronunciare le parole antiche,
offrire il simbolo del regno.

Nulla di più.

Eppure…
quando lui si inginocchia davanti a me,
il tempo rallenta come neve nell’aria.

I suoi occhi non chiedono nulla.
Ed è questo che spezza il mio cuore.
...
che tutta Camelot potesse vedere
ciò che io stessa
non oso ancora nominare.

Arthur era lì.
Nobile.
Silenzioso.
Fidandosi di noi
come soltanto gli uomini veramente buoni
sanno fare.
...
Io non desidero distruggere nulla.
Non il re.
Non Camelot.
Non la pace costruita con tanta fatica.

Eppure il mio sangue ricorda qualcosa
che la ragione non può comandare.
...
something has just begun to fall.`
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Le sale finalmente si svuotano.
Le ultime torce tremano nel vento.
E Camelot…
Camelot sembra respirare
come una creatura viva dopo il canto.

Ho visto uomini sorridere questa sera
che un tempo parlavano soltanto di guerra.
Ho visto bambini addormentarsi
senza stringere paura fra le mani.

Per questo ho creduto.
Per questo ho portato il peso della corona
anche quando le ossa chiedevano riposo.
...
anche il cuore più forte lo sente.
Come il mare avverte la tempesta
prima ancora che il vento si alzi.

Non so quale porta si sia aperta.
Non so quale stella abbia mutato luce.
Ma Camelot stanotte
sembra più bella…
...
and therefore more fragile.`
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Lancelot porta negli occhi
quella fede che gli uomini perdono crescendo.
Guardandolo,
perfino i vecchi cavalieri
...
Perché allora sento freddo?

Forse ogni regno
comincia a cadere
nel momento esatto
in cui si crede eterno.
...
da ciò che cresce invisibile.

Se questa è felicità,
perché somiglia tanto alla malinconia?

E se il destino entra negli uomini
non con il ferro,
ma con la bellezza…
allora nessun re
potrà fermarlo.

Le ultime torce si spengono piano.
Camelot dorme sotto le stelle.
E io resto sveglio
ad ascoltare
...
act2_2: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `La pioggia cade lenta sulle torri.
Camelot dorme
credendosi eterna.

Eppure perfino stanotte
una regina ha bussato alla mia porta
con paura negli occhi.

Guinevere…
così nobile nel portare il silenzio.
Così attenta a scegliere le parole
come chi teme il proprio stesso cuore.
...
Biancospino contro la febbre del sangue.
...
Io vedo ciò che cresce nel silenzio.
Vedo il desiderio
prima ancora che impari il proprio nome.
...
Ti darò ciò che chiedi.
Un figlio.
Un’eredità.
Una radice che nessun inverno spezzerà.
...
Ma nessun regno
può prendere tutto
senza lasciare qualcosa indietro.

Se il mondo degli uomini
deve divorare il mistero,
allora il mistero vivrà
dentro il figlio del loro sogno.

Nel sangue…
nel sangue del futuro…

Così preparo il vino.
Così intreccio il destino.
Così la nebbia
entra silenziosa
...
Camelot commercia col mare.
Camelot parla con Roma.
Camelot manda giudici e cavalieri
dove una volta c’erano soltanto foreste.
...
E Merlin…
Merlin appare sempre meno nelle sale.

Le campane continuano.
I mercati continuano.
...
act2_4: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Di notte il lago non dorme mai.

Gli altri sentono soltanto vento,
canneti,
acqua contro le pietre.

Ma sotto il silenzio
qualcosa continua a parlare.

Camelot ride ancora nelle sale.
Le coppe si alzano.
Le campane cantano vittoria.
...
If a kingdom becomes nothing more than the memory of itself,`
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Io ascolto le acque
perché gli uomini parlano troppo.
Io torno alla nebbia
perché la verità teme la luce delle sale.
...
act2_5: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Una volta Camelot respirava come fuoco.
Ora respira come cenere calda:
ancora viva…
ma stanca.

Le sale sono piene ogni sera.
Risate.
Musica.
Vino versato fino all’alba.

Eppure ricordo un tempo
in cui bastava uno sguardo
per sentire il cuore del regno battere.

Ora tutto continua…
senza ardere davvero.
...
Perché l’amore non muore sempre nel fuoco.
A volte si allontana piano,
come nebbia sopra il lago,
lasciando intatte le forme…
ma svuotando il calore.
...
without ever truly meeting.`
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Anche Lancelot ride meno di un tempo.
Porta ancora onore nelle sale,
...
Forse è questo il destino dei regni:
trasformare lentamente gli uomini
nei simboli che il popolo desidera.

E i simboli…
non sanno più toccarsi.

Le stanze di Camelot sono troppo silenziose
dietro tutta la musica delle feste.
Troppo perfette.
Troppo ordinate.

Come se il regno intero
trattenesse il respiro
aspettando qualcosa
che nessuno osa nominare.

E io…
che ho voluto pace sopra ogni cosa…
comincio a temere
la quiete che abbiamo costruito.
...
act2_6: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Lancelot",
      original: `Le sale sono silenziose ormai.
Anche le ultime torce
si consumano senza rumore.

E Camelot dorme…
fidandosi ancora di noi.

Arthur mi ha dato un posto alla sua tavola
prima ancora di conoscere davvero il mio nome.
Mi ha offerto fiducia
con quella semplicità rara
che appartiene soltanto agli uomini buoni.

E io lo avrei seguito
...
prima che il silenzio impari il nostro nome.
Prima che uno sguardo trattenuto troppo a lungo
diventi ferita nel cuore del regno.

Perché io amo Arthur.
Amo ciò che ha costruito.
Amo questa terra
...
Se ci fosse menzogna
potrei odiare facilmente me stesso.
Ma ciò che nasce fra noi
somiglia troppo alla verità.
...
a portare l’inverno dentro queste mura?

Dovrei lasciare Camelot
prima che il fuoco consumi ciò che amo.
Prima che Arthur impari
a riconoscere il silenzio nei nostri respiri.

Ma ogni volta che provo a partire
...
Forse gli dèi puniscono gli uomini
non con l’odio…
ma concedendo loro
troppa bellezza.
`,
...
Ma la loro voce
somiglia sempre più
a un vecchio sogno dimenticato al mattino.

Anche il drago dorme più profondamente.
Non sento più il fuoco
respirare sotto la roccia
come un tempo.
...
Quando tacciono le pietre,
anche gli uomini cambiano.
Dimenticano il peso delle stelle.
Dimenticano che il mondo
era vivo prima dei loro regni.
...
to a door slowly closing.`
    ...
    },
    {
      type: "line",
      voice: "Merlin",
      original: `Arthur porta ancora il peso con dignità.
Guinevere nasconde il dolore con grazia.
Lancelot ama troppo profondamente
...
ha scelto lui
nel momento stesso
in cui ha smesso di parlare a me.
...
la nebbia lo raccoglie pazientemente
fra acqua,
radici,
e sangue.

Ho custodito il passaggio per tutta la vita.
Ho tenuto chiuse porte
che gli uomini non comprendevano.

Ma nessun custode resta eterno.
Nemmeno il drago.
Nemmeno Avalon.
Nemmeno io.
...
di aver dato ordine al mondo.

La nebbia ritorna.

Da bambino avevo paura di queste acque.
Ora temo di più
il silenzio delle sale di Camelot.
...
But as the memory of the earth.`
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Una volta i re ascoltavano le colline.
Una volta le foreste custodivano il sacro.
Una volta il mare
...
act2_9: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `La notte non appartiene più agli uomini.

Camelot dorme dietro le sue mura,
credendosi ancora eterna,
...
La lama che porta ancora
il peso del giuramento antico.

Prendi questo spiedo.

Non cercare gloria.
Non cercare vicinanza.
Non lasciare che il sangue
trasformi il coraggio in follia.
...
Perché Arthur…
Arthur combatte ancora
come l’uomo che era un tempo.

E gli uomini più pericolosi
sono quelli
...
Avalon…`
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `per ricordare il proprio nome…
...
act2_10: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Stanotte il lago tace.

Nessuna voce nella nebbia.
Nessun canto sotto l’acqua.
Perfino il vento
sembra aver deposto il proprio peso.

Avalon ha già parlato.

Da bambino temevo il silenzio.
Ora comprendo:
esistono notti
in cui il mondo smette di chiedere.

E resta soltanto
ciò che un uomo decide di essere
davanti al proprio destino.

Arthur verrà.
Excalibur verrà.

E il sangue di Britannia
...
I feel no glory.`
    },
    {
      type: "line",
      voice: "Mordred",
      original: `In un mondo migliore
questa guerra non avrebbe avuto bisogno di nascere.

Ma Camelot ha camminato troppo lontano
...
while Avalon still called.`
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Ricordo le sale illuminate.
Le risate.
...
I truly loved it.`
    },
    {
      type: "line",
      voice: "Mordred",
      original: `Forse è questo
che rende il destino così pesante:
dover ferire ciò
che una volta sembrava casa.

Non temo più la morte.

La morte è soltanto una porta
che gli uomini fingono di non vedere
finché non sentono il suo respiro vicino.
...
I see it clearly.`
    ...
    },
    {
      type: "line",
      voice: "Mordred",
      original: `che Britannia avrebbe ricordato
il proprio nome perduto.

Se devo cadere perché ciò accada,
allora lascio il mio sangue
alla nebbia,
al lago,
e alle colline antiche.

Perché alcune verità
costano più della vita degli uomini.

Stanotte il lago tace.
...
Britannia trattiene il respiro.
...
E il cielo non sceglie fra gli uomini.

Ho combattuto accanto a lui vent’anni!
— E ora alzo il ferro contro il suo volto!

Dove sono finite le sale illuminate?
...
Perché alcune guerre
continuano anche dopo la morte dei sogni.

Arthur avanza nella pioggia!
Mordred attraversa la nebbia!

Excalibur brilla ancora
come ultimo fuoco del mondo antico!

E Britannia guarda
i propri figli
massacrarsi sotto il cielo grigio.

Non sento più gli ordini!
— Non vedo più le insegne!

Dio abbia pietà di noi!
— Avalon abbia pietà di noi!
...
Camelot cade
non nel fuoco…
ma nel peso delle sue stesse ferite.

La pioggia continua.
Il fango continua.
Le urla diventano silenzio.

E nessuno canta vittoria.

Perché qui finisce qualcosa
più antico dei re.
Più fragile delle mura.
...
act3_2: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `La pioggia cade ancora sopra Camlann.

Troppi morti.
Troppi nomi perduti nel fango.

E io…
io non volevo arrivare fino a questo.

Per ore sono rimasto lontano dal centro della battaglia.
Lasciando ai miei cavalieri
ciò che un padre non dovrebbe vedere.

Continuavo a sperare
che Mordred si fermasse.
Che bastasse una parola.
Un gesto.
Un ultimo frammento d’amore
rimasto vivo fra il sangue.

Poi ho visto la sua armatura.

Nera come notte antica.
Immensa.
Immobile sotto il ferro degli uomini.

Le lance si spezzavano contro di lui
...
to wish for victory.`
    ...
    },
    {
      type: "line",
      voice: "Arthur",
      original: `Lui mi guardava attraverso la pioggia
senza odio.
Quasi con tristezza.

Come un uomo
che vede crollare la propria casa
e continua comunque ad avanzare.

E in quel momento
ho compreso la verità più crudele:

anche Mordred
stava tentando di salvare qualcosa.

Ma il destino non apre porte.
Le chiude.

Così Excalibur si è levata
come sole dentro la tempesta.

E il fuoco antico
ha finalmente riconosciuto
la forgia del drago.

La lama ha attraversato l’armatura
in una luce bianca
più feroce del giorno.

E il cuore di mio figlio
si è spezzato contro il mio nome.

Poi…
ho guardato verso il basso.

E ho visto il suo spiedo
attraversare il mio fianco
come inverno dentro carne viva.

Così termina Camelot.

Non nel trionfo.
Non nella gloria.

Ma nel momento
in cui un padre e un figlio
si uccidono
credendo entrambi
di salvare Britannia.

Excalibur brucia ancora nella pioggia.
Mordred cade fra fango e silenzio.
E io sento già il mondo antico
allontanarsi dalle colline.

Forse nessuno di noi
aveva davvero torto.

Forse era soltanto giunto il tempo
che Britannia cambiasse pelle
nel sangue dei suoi figli.

La pioggia continua sopra Camlann.
...
Ma nessun sogno proibito,
nessuna dolcezza rubata,
vale il peso
di vederti così.
...
si è steso fra noi
come inverno sopra il lago.

Ti ho amato
perfino mentre il mio cuore
si smarriva nella luce di un altro.

E adesso tutto ciò che resta
...
and my hands.`
    ...
    },
    {
      type: "line",
      voice: "Guinevere",
      original: `Le sale di Camelot echeggiano vuote.
I cavalieri abbassano gli occhi.
Perfino le torce sembrano tremare
come creature impaurite.
...
Quanto peso portavi
dietro ogni sorriso offerto al regno.

Dovevo stringerti più forte.
Dovevo parlarti prima che il silenzio
diventasse muro.

Ma gli uomini imparano il valore dell’amore
soltanto quando il destino
inizia a strapparlo via.

Arthur…
perdonami…

Perdonami per ogni sguardo trattenuto.
Per ogni verità lasciata morire nel cuore.
Per ogni primavera cercata altrove
mentre tu costruivi pace per il mondo intero.
...
act3_5: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Merlin",
      original: `La pioggia ha quasi cancellato i nomi.

Camlann dorme sotto fango e sangue,
come se la terra stessa
volesse chiudere gli occhi
su ciò che gli uomini hanno fatto.

Troppi volti conosciuti.
Troppi giuramenti spezzati.

E Britannia…
Britannia tace finalmente.

Non resta più rabbia.
Non resta più gloria.
...
`
    ...
    },
    {
      type: "line",
      voice: "Merlin",
      original: `La nebbia si apre ancora una volta.
Silenziosa.
Antica.
Stanca quanto me.
...
act3_6: {
  menuTitle: " La nebbia scompare",
  title: "La nebbia scompare",
  showPlaceholder: false,
  blocks: [
    {
      type: "scene",
...
act3_7: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `Le torce si consumano lentamente.
...
Non parlare.
Non sprecare il poco respiro che resta.

Ho portato qualcosa per il dolore.
...
Ora lo vedo.
Il tormento lascia lentamente i tuoi occhi.
...
like ice beneath the sun.`
    ...
    },
    {
      type: "line",
      voice: "Morgaine",
      original: `ha mai portato il peso della corona
con tanta dolcezza.

Nessun uomo
ha mai amato il proprio popolo
fino a consumarsi completamente.


Forse eravamo entrambi troppo antichi.

Tu nato per un mondo
che gli uomini non meritavano ancora.
Io nata per uno
...
ci ha chiesto di scegliere
fra due metà della stessa anima.
...
act3_8: {
  ...
  blocks: [
    ...
    },
    {
      type: "line",
      voice: "Lancelot",
      original: `Le sale di Camelot sono vuote.
...
Non esiste giudice più crudele
...
Non pronuncerò il suo nome
come fanno gli uomini
quando cercano di trasformare il rimorso in poesia.

Ciò che esisteva fra noi
appartiene ormai ai morti.

Che cosa resta a un cavaliere
quando il regno è caduto
